...
//////////////
  ...
  const HandelSubmit=(e)=>{
    e.preventDefault()
     dispatch( addfoyer(Input.nom,Input.model,Input.vaccin,Input.taille,Input.age,Input.image,Input.date,Input.critére,Input.datepre,Input.datefin))
 ...
 Remplire formulaire de foyer de votre chien
      </Button>
  ...
  <Form.Label>Date pré</Form.Label>
    ...
    <Form.Control type="text" placeholder="Enter la date de pré " name="datepre" onChange={HandelChange}/>
  </Form.Group>

  <Form.Group className="mb-3" controlId="formBasicCheckbox3">
  <Form.Label>Date fin</Form.Label>
  
    <Form.Control type="text" placeholder="Enter la date de fin " name="datefin" onChange={HandelChange}/>
  </Form.Group>
