...
const Updfoyer = ({el,id}) => {
  ...
  const dispatch = useDispatch()
    ...
    const updfoyer=()=>{
        dispatch (updatefoyer(id, update.nom, update.model,update.taille ,update.critére,update.age,update.image,update.vaccin,update.date,update.datepre,update.datefin)) 
