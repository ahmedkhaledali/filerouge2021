...
import {updatechien} from "../action/chienaction"
import {useDispatch} from 'react-redux'

const Updchien = ({el,id}) => {
  ...
  const dispatch = useDispatch()
    ...
    const uptchien=()=>{
        dispatch (updatechien(id, update.nom, update.model,update.taille ,update.critére,update.age,update.image,update.vaccin,update.date)) 
...
<Button variant="dark" type="submit"  onClick={uptchien} >valider</Button>
</Form>
</Modal.Body>
