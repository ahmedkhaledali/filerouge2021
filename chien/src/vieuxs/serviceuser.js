...
import Navbaruser from '../Composent/navbaruser'
import { Container,Row,Col } from "react-bootstrap";
import React, { useState} from 'react'
function Nserviceuser() {
...
<Link className="nav-link"  to="/dressageuser">
...
<Link className="nav-link"  to="/foyeruser">
...
<Link className="nav-link"  to="/raceuser">
